...
class FallDetectionSystem:
    ...
    def __init__(self, connection, limits: Optional[StabilityLimits] = None):
    ...
    async def _collect_sensor_data(self) -> Tuple[Optional[OrientationData], Optional[MotionData]]:
